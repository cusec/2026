export default function CodeOfConduct() {
  return (
    <div className="h-fit bg-dark-mode/60 text-light-mode w-11/12 sm:w-8/12 md:w-9/12 lg:w-4/5 p-8 rounded-4xl backdrop-blur-sm">
      ...
      <h2 className="text-3xl font-bold mt-8 mb-4 text-left">The Pledge</h2>
      <p className="mb-4 text-left">
      ...
      <h2 className="text-3xl font-bold mt-8 mb-4 text-left">The Standards</h2>
      <p className="mb-4 text-left">
      ...
      <h2 className="text-3xl font-bold mt-8 mb-4 text-left">Enforcement</h2>
      <p className="mb-4 text-left">
        Violations of the Code of Conduct may be reported by sending an email to{" "}
        <strong>incidents@cusec.net</strong>. All reports will be reviewed and
        investigated, resulting in responses deemed appropriate. We reserve the
        right to remove comments or contributions not aligned with this Code of
        Conduct.
      </p>
      <p className="mb-4 text-left">
        Conference staff are available to help participants contact hotel/venue
        security, local law enforcement, provide escorts, or assist those
        experiencing harassment.
      </p>

      <h2 className="text-3xl font-bold mt-8 mb-4 text-left">
        Contact Information
      </h2>
      <p className="mb-4 text-left">
