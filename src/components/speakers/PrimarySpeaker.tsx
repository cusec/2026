...
export default function PrimarySpeaker({
  ...
  return (
    <div
      key={key}
      className="flex flex-col sm:flex-row w-full gap-5 mb-[2vh] text-light-mode"
    >
      <div className="min-w-[25vw] max-w-[25vw] min-h-[25vw] max-h-[25vw] md:min-w-[18vw] md:max-w-[18vw] md:min-h-[18vw] md:max-h-[18vw] relative overflow-hidden rounded-xl group">
        <Image
          src={speaker.image}
          alt={speaker.name}
          fill
