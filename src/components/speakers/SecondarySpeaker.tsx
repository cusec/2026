...
export default function SecondarySpeaker({
  ...
  return (
    <div
      key={key}
      className="flex flex-col justify-between items-center text-center w-full h-[520px] xs:w-[330px] xs:h-[570px] py-10 text-light-mode font-se rounded-xl border border-light-mode/50 bg-light-mode/15 transition-all duration-300 ease-in-out hover:bg-light-mode/20 group"
    >
