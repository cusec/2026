...
const BasicCard: React.FC = () => {
  return (
    <div className="max-w-[400px] md:max-w-full flex flex-col justify-center text-center text-light-mode px-2 md:px-4 py-6 md:py-12 transition-all duration-500 ease-in-out bg-dark-mode/25 hover:bg-dark-mode/50 border-6 border-white/10 rounded-4xl shadow-lg backdrop-blur-xs">
      ...
      <h3 className="text-xl md:text-3xl mb-4 md:mb-6">$120 / Professional</h3>
      <a
