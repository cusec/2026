...
export default function Member({
  ...
  return (
    <div
      key={key}
      onClick={handleClick}
      className={`mb-2 relative flex flex-col items-center justify-between w-full h-[450px] xs:w-[275px] xs:h-[400px] sm:w-[330px] sm:h-[470px] pt-6 pb-12 rounded-xl border-1 border-light-mode/70 bg-light-mode/40 overflow-hidden group sm:cursor-default cursor-pointer ${
        isActive ? "active" : ""
      }`}
    >
      {/* Gradient overlay - fades in on hover or active state */}
      <div className="absolute inset-0 rounded-xl bg-linear-[215deg] from-sunset/30 to-secondary/30 opacity-0 transition-opacity duration-500 ease-in-out group-hover:opacity-100 group-[.active]:opacity-100 z-0" />

      {/* Image - positioned absolutely, moves to top-right on hover or active state */}
      <div className="absolute left-1/2 top-8 -translate-x-1/2 w-[180px] h-[180px] xs:w-[150px] xs:h-[150px] sm:w-[200px] sm:h-[200px] transition-all duration-500 ease-out group-hover:w-[120px] group-hover:h-[120px] group-hover:left-[calc(100%-135px)] group-hover:top-4 group-hover:-translate-x-0 group-[.active]:w-[120px] group-[.active]:h-[120px] group-[.active]:left-[calc(100%-135px)] group-[.active]:top-4 group-[.active]:-translate-x-0 z-10">
        ...
        <div className="absolute top-2 left-2 w-10 h-10 xs:w-8 xs:h-8 z-20 transition-all duration-500 group-hover:scale-60 group-hover:top-0 group-hover:left-0 group-[.active]:scale-60 group-[.active]:top-0 group-[.active]:left-0">
      ...
      <div className="w-full h-full px-4 flex flex-col items-center justify-start pt-[220px] xs:pt-[190px] sm:pt-[240px]">
        ...
        <div className="absolute bottom-4 left-0 right-0 flex sm:hidden items-center justify-center gap-3 px-4 z-30 opacity-0 transition-all duration-300 group-hover:opacity-100 group-[.active]:opacity-100">
          {socialEntries
